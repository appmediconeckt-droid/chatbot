...
//   // Find the handleVerify function and replace it with this:
...
//       // Navigate to OTP verification page with role
//       navigate("/verify-login-otp", { 
//         state: { 
//           email: formData.email,
//           role: "counselor" // This tells the OTP page it's a counselor
//         } 
//       });
//     } else {
//       setApiError(verifyResponse.data?.message || "Failed to send OTP");
//       showNotification(verifyResponse.data?.message || "Failed to send OTP", "error");
//     }
//   } catch (error) {
